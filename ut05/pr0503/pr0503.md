...
Accedemos a "Administración de directivas de grupo" desde Administrador del servidor > Herramientas, ahí buscaremos la unidad organizativa Alumnado, le daremos click derecho y hacemos click en "Crear un GPO en este dominio y vincularlo aquí. Le asignamos de nombre GPO_ALU_RESTRICCIONES para identificarlo mejor.
...
Si en lugar de Directivas de cuenta entramos a Directivas locales > Opciones de seguridad, podremos editar la directiva "Cuentas: cambiar el nombre de la cuenta de usuario", le ponemos AdministradorLocal1.
